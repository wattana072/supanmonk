...
const CONFIG = {
    ...
    GAS_URL: 'https://script.google.com/macros/s/AKfycbz7nFguQ-W7n9Zy360-rFLa5rEC26Cu6nyLNvoTcB7vnQHrjaczCJtBtKUgrTQ3T9KX/exec'
};
    ...
    monkListEl.innerHTML = data.map(m => `
        <div class="list-item" onclick="openEditModal('${m.ID}')">
            <div class="list-item-content">
                ...
                <p>กลุ่ม: ${m.Group || '-'} | ที่จำวัด: ${m.Bedroom || '-'}</p>
            </div>
